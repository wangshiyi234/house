...
public class TestClient {
    ...
    public static void main(String[] args) {
        ...
        request.setBizContent("{\"mobile\":[\"18811920974\"],\"type\":0,\"template_id\":\"ST_2020101100000003\",\"sign\":\"" + singnstr +"\",\"send_time\":\"\",\"params\":{\"code\":5637}}");  // 这里是json字符串，send_time 为空时可以为null, params 为空时可以为null,短信签名填写审核后的签名本身，不需要填写签名id
