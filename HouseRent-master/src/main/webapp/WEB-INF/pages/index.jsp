    ...
    <div class="layui-header title">
        <div class="layui-container">
            ...
            <c:if test="${not empty loginUser }">
                ...
                <div class="personalCenter layui-pull-right"><a href="createDan" target="_blank" style="color:#fff"><i class="layui-icon layui-icon-tree"></i>结算</a></div>
                ...
                <div class="" style="margin: 40px 20px;">
                    <form class="layui-form layui-form-pane" id="login">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="mycode" required  lay-verify="required" placeholder="请输入验证码" autocomplete="off" class="layui-input">
                                <br>
                                <img src="http://localhost:8081/kaptcha" onclick="this.src=this.src+'?'" id="">
                            </div>
                        </div>
                        <br>
                        <img>
                ...
                <div class="" style="margin: 30px 20px;">
                    <form class="layui-form layui-form-pane form">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="uPhoneNumber" required  lay-verify="required" placeholder="输入手机号" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <input type="submit" class="getcode-btn" value="发送验证码" />
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">验证码</label>
                            <div class="layui-input-block">
                                <input type="text" name="uCode" required  lay-verify="required" placeholder="输入验证码" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">昵称</label>
                            <div class="layui-input-block">
                                <input type="text" name="uNickName" required  lay-verify="required" placeholder="请输入昵称" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    </form>
                    <div class="layui-form-item">
...
<script >
    ...
    layui.use(['element', 'carousel','layer','form'], function () {
        ...
        $('.regist-btn').click(function () {
            if ($("input[name='uCode']").val()!="5637"){
                layer.msg("验证码错误");
            }else if($("input[name='uName']").val()!=""&&$("input[name='uPassword']").val()!=""&&$("input[name='uPhoneNumber']").val()!=""&&$("input[name='uNickName']").val()!=""){
        ...
        $('.getcode-btn').click(function () {
            $.post("getcode",$('.form').serialize(),function (res){
